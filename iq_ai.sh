...
iqaimain=" sigmoid tanh tanh_pade sigmoid_tanh softmax soft2max softplus softsign "
iqaiderivs=" sigmoid_d1 sigmoid_d2 softplus_d1 sofsign_d1 tanh_d1 tanh_d2 "
iqai_experimental=" relu leaky_relu sgn relu_d1 leaky_relu_d1 swish logish mish serp serp_newton "
...
leaky_relu_d1() { case $1 in -s*) shift ;;esac
...
swish1() { case $1 in -s*) scale=${1#-s*} ; shift ;; *) scale=$defprec ;; esac
    x=$1
